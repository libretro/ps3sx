...
void resampler_float_to_s16(int16_t * __restrict__ out, const float * __restrict__ in, size_t samples);
void resampler_s16_to_float(float * __restrict__ out, const int16_t * __restrict__ in, size_t samples);
